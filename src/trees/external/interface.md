...
Namely, these are *completeness* (honest proofs verify), *soundness* (cannot generate proofs for false statements), and *succinctness* (proof is small and verification is cheaper than re-execution).
